...
knowledge-share-postgres:
	./scripts/test-knowledge-share-postgres.sh

knowledge-share-old-app:
	./scripts/test-knowledge-share-old-app.sh

knowledge-thread-promotion-postgres:
	./scripts/test-knowledge-thread-promotion-schema-postgres.sh

knowledge-thread-promotion-old-app:
	./scripts/test-knowledge-thread-promotion-old-app.sh

knowledge-llm-budget-postgres:
	./scripts/test-knowledge-llm-budget-postgres.sh

knowledge-llm-old-app:
	./scripts/test-knowledge-llm-old-app.sh
