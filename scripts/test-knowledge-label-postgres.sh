...
CONTAINER_NAME="erp4-knowledge-label-test-$$"
...
TEST_DATABASE="erp4_knowledge_label_test"
TEST_USER="erp4_label_test"
TEST_PASSWORD="erp4_label_test_only"
...
export KNOWLEDGE_LABEL_INTEGRATION_CONFIRM=1
...
node "$ROOT_DIR/packages/backend/scripts/knowledge-label-integration.mjs"
npx --prefix "$ROOT_DIR/packages/backend" prisma migrate status \
  --config "$ROOT_DIR/packages/backend/prisma.config.ts" >/dev/null

echo "knowledge label PostgreSQL integration: PASS"
