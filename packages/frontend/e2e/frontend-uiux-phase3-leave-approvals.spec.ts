...
test('phase 3 leave and approval UX/UI summaries render @core', async ({
  page,
}) => {
  ...
  const cases = [
    {
      label: '休暇申請',
      heading: '休暇',
      summaryLabel: '休暇申請判断サマリー',
      screenshot: '01-uiux-leave-requests.png',
    },
    {
      label: '承認',
      heading: '承認一覧',
      summaryLabel: '承認判断サマリー',
      screenshot: '02-uiux-approvals.png',
    },
  ];
