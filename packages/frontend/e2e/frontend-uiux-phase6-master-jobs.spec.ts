...
test('phase 6 master data and admin jobs UX/UI summaries render @core', async ({
  page,
}) => {
  ...
  const cases = [
    {
      ...
      screenshot: '01-uiux-master-data.png',
    },
    {
      label: 'ジョブ管理',
      heading: '運用ジョブ',
      summaryLabel: '運用ジョブサマリー',
      screenshot: '02-uiux-admin-jobs.png',
    },
  ];
