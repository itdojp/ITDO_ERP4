...
import { registerLocalAuthRoutes } from './auth/localAuthRoutes.js';
import { registerLocalCredentialAdminRoutes } from './auth/localCredentialAdminRoutes.js';
import { registerUserIdentityAdminRoutes } from './auth/userIdentityAdminRoutes.js';
...
export async function registerAuthRoutes(app: FastifyInstance) {
  ...
  await registerUserIdentityAdminRoutes(app);
  await registerLocalCredentialAdminRoutes(app);
}
