...
const contexts = [
  ...
  },
  {
    ...
    patterns: [
      ...
      '^src/routes/knowledge(Items|Labels|Search|SavedViews|Snapshots|Annotations|Conversations|ConversationImports|Syntheses|ProvenanceSchemas|RouteContext)\\.ts$',
    ],
  },
  {
    name: 'notifications',
