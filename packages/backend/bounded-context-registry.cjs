...
const contexts = [
  ...
  },
  {
    ...
    patterns: [
      ...
      '^src/routes/knowledge(Items|Labels|Search|SavedViews|Snapshots|Annotations|Conversations|ConversationImports|Syntheses|Shares|ThreadPromotions|LlmRuns|ProvenanceSchemas|RouteContext)\\.ts$',
    ],
  },
  {
    name: 'notifications',
