...
const contexts = [
  ...
  },
  {
    ...
    patterns: [
      ...
      '^src/routes/knowledge(Items|Labels|Search|SavedViews|Snapshots|Captures|Annotations|Conversations|ConversationImports|Syntheses|Shares|ThreadPromotions|LlmRuns|ProvenanceSchemas|RouteContext)\\.ts$',
    ],
  },
  {
    name: 'notifications',
...
const layers = [
  {
    ...
    patterns: [
      ...
      '^src/application/invoices/.+\\.ts$',
      '^src/application/estimates/.+\\.ts$',
      '^src/application/purchaseOrders/.+\\.ts$',
