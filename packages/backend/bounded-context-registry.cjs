...
const contexts = [
  ...
  },
  {
    ...
    patterns: [
      ...
      '^src/routes/knowledge(Items|Labels|Search|SavedViews|Snapshots|Annotations|Conversations|ConversationImports|Syntheses|Shares|ThreadPromotions|ProvenanceSchemas|RouteContext)\\.ts$',
    ],
  },
  {
    name: 'notifications',
