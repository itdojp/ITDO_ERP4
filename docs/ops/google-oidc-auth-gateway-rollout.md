...
VITE_AUTH_MODE=jwt_bff VITE_API_BASE=https://api.example.com VITE_ENABLE_SW=true VITE_PWA_SHARE_TARGET_MODE=enabled npm run build --prefix packages/frontend
```
