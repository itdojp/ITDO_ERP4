...
| auth         | `NODE_ENV=production`、`AUTH_MODE=jwt_bff`、trial 専用 OAuth client、trial専用の32 UTF-8 bytes以上の`KNOWLEDGE_CURSOR_SIGNING_SECRET`と別のstableな`KNOWLEDGE_CAPTURE_IDEMPOTENCY_SECRET` |
