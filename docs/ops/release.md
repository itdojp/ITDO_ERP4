...
- 過去30日以内の backup/restore 証跡を確認（`docs/test-results/YYYY-MM-DD-backup-restore.md` または `docs/test-results/YYYY-MM-DD-dr-restore-rN.md` を推奨。実施日時・実施者・対象環境・使用した archive/log を含むこと、`docs/ops/backup-restore.md`）
...
- DR 復元演習ログを `scripts/record-dr-restore.sh` で記録した場合は、生成された記録ファイルへの参照を release 証跡へ残す
