...
hard-limit残高から除外される累積release counterは、月内の反復reserve/releaseでもBIGINT overflowしない`NUMERIC(38,0)`のinteger micro-unitとし、reservation ledgerとの一致をdeferred constraintで検証する。
