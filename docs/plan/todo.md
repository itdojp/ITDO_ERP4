...
## 次アクション（未決定事項の確定）
- [ ] #408 損益/工数予実 未決定事項の確定
- [ ] #409 見積/請求/発注 UI 未決定事項の確定
- [ ] #410 定期案件テンプレ 未決定事項の確定
- [ ] #411 案件/タスク/マイルストーン編集 未決定事項の確定
- [ ] #412 GRC/監査 未決定事項の確定
- [ ] #413 AI/分析 未決定事項の確定

## 次アクション（実装計画）
- [ ] #416 Project予算フィールド追加と損益/アラート調整
- [ ] #417 Task付け替え時の工数一括移動
- [ ] #418 マイルストーン更新と請求ドラフト連動
- [ ] #419 Project親変更の理由必須/監査ログ
- [ ] #420 定期案件テンプレのデフォルト調整
## 次アクション（Phase 3 着手）
