...
- ICS 仕訳 mapping rule
  ...
  - `mappingKey`, `debitAccountCode`, `creditAccountCode`, `taxCode`, `departmentCode`, `requireDepartmentCode`, `requireDebitSubaccountCode`, `requireCreditSubaccountCode`, `isActive`
