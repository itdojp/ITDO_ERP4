...
- **alert_settings**: type (budget_overrun/overtime/approval_delay), threshold, period, scope (global/project_id), recipients (emails/roles/users), channels (email/dashboard/ext_future), is_enabled
