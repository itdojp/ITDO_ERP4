...
- **chat_rooms / chat_messages**: `ChatRoom(id, type, project_id?, name, acl, allow_external_users, ...)` と `ChatMessage(id, room_id, user_id, body, tags, reactions, created_at)` を用いる room-based モデル。
