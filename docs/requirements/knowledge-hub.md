...
| storage readiness      | OAuth/quota/freshness/retention の scripts/docs/timer                                                   | `packages/backend/src/infrastructure/storage/storageReadiness.ts`、`scripts/ops/check-storage-readiness.sh`、`docs/ops/storage-readiness.md`                                                                 | Knowledge 容量/失敗指標は workstream 11 から接続する                                                                                        |
