...
| チャット（案件ルーム/全社/部門/private_group/DM） | user / hr / 外部ユーザ（グループACL） | `docs/test-results/2026-02-05-frontend-e2e-r1/14-room-chat.png`                                                                                                                                                                               | `docs/manual/ui-manual-user.md` / `docs/manual/chat-guide.md`            |
