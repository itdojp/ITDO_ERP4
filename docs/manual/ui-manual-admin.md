...
- 目的: 工数・予実・稼働の可視化
- 主な操作: 期間/案件/ユーザの設定、工数・PJ別採算・残業・管理会計サマリ・バーンダウン・EVM の取得
...
5. `グループ別工数` では userIds を指定して取得する
6. `個人別残業` では userId を指定して取得する
7. `管理会計サマリ` で全社KPIの初期値を取得する
8. ベースラインを選択し `バーンダウン` を取得する
9. `EVM` を取得する
