...
![Step1 ダッシュボード](../test-results/2026-03-09-frontend-e2e-r1/01-core-dashboard.png)
...
![Step2 プロジェクト](../test-results/2026-03-09-frontend-e2e-r1/09-projects.png)
...
![Step3 メンバー管理](../test-results/2026-03-09-frontend-e2e-r1/09-project-members.png)
...
![Step4 タスク](../test-results/2026-03-09-frontend-e2e-r1/21-project-tasks.png)
...
![Step5 マイルストーン](../test-results/2026-03-09-frontend-e2e-r1/23-project-milestones.png)
...
![Step6 横断検索](../test-results/2026-03-09-frontend-e2e-r1/06-core-global-search.png)

### Step 7: 休暇申請の上長向け一覧を確認する

1. 「休暇申請」を開く
2. `上長向け一覧を読み込み` を実行する
3. 担当案件メンバーの申請（`draft` 以外）が一覧に表示されることを確認する
4. 理由（`notes`/`相談無し理由`）が表示されないことを確認する

完了条件:

- 上長として参照可能な休暇申請一覧を確認できる

![Step7 休暇](../test-results/2026-03-09-frontend-e2e-r1/22-leave-requests.png)
