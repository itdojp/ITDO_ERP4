...
| origin confusion／message spoofing          | exact build origin、extension ID、`event.source === window`、event origin、draft ID、schema、one-time nonce、server-confirmed actor由来fingerprintを照合。fingerprintをserver署名とは扱わない |
