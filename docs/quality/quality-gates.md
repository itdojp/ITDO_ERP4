...
| chat         | `CI / backend`       | `packages/backend/coverage/chat/coverage-summary.json`         | `packages/backend/coverage-thresholds.json` | statements/lines 54.6%、branches 59.9%、functions 68.3% |
