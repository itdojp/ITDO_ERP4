...
| 監査ログUIから AgentRun 詳細へドリルダウンできる                | 監査ログの AgentRun 列 `詳細` から run/step/decision が表示されることを確認する                                            | E2E: `packages/frontend/e2e/frontend-smoke-audit-agent-run.spec.ts` + backend route/unit: `packages/backend/test/agentRunRoutes.test.js`, `packages/backend/test/agentRunRecorder.test.js`                                                                                                                                                               |
