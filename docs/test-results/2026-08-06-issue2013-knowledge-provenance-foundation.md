...
| delegated auth scope/expiry contract                | PASS   | URI path保持、100/101件、255/256文字、empty actor互換、Unicode control/bidi/surrogate/query/userinfo拒否、`exp` safe integer境界         |
...
Result: **71/71 PASS**（provenance 61 + delegated auth/identity/expiry 10、fail/skip/todo 0）
...
76.25%、functions 100%、shared auth identifier validatorはstatements/lines/branches/functions 100%、
shared auth scope validatorはstatements/lines 92.85%、branches 76.47%、functions 100%、request access contextはstatements/lines/functions 100%、branches
50.00%だった。実DB経路は
