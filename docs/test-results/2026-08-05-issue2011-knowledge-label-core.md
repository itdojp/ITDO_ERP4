...
| focused Knowledge item + label tests          | PASS   | 58 tests、fail/skip/todo 0。schema/migration/OpenAPI/harness 14、adapter 11、route 6、use case 14、既存Knowledge item route 13                               |
...
| backend full test                                 | PASS    | 1,606 tests、fail/skip/todo 0                                                                     |
