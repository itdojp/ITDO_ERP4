...
- release backup/restore 証跡テンプレート: docs/test-results/release-backup-evidence-template.md
...
- フロントE2E(管理設定 会計マッピングルール UI エビデンス r1): docs/test-results/2026-03-17-frontend-e2e-r1.md
