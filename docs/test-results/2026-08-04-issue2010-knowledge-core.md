...
| `npm run test --prefix packages/backend`                          | PASS   | 1,550 tests、skip/todo 0                                                                                                                                                                                                                                                                     |
| `npm run coverage:auth:check --prefix packages/backend`           | PASS   | auth 153 tests。S/L 90.28%、B 71.18%、F 98.66%。既存閾値の低下なし                                                                                                                                                                                                                           |
